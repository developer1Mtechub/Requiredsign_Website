...
function AboutUs() {
    ...
    return (
        <>
            <Box id=" " pt={16} pb={10} sx={{ backgroundColor: "#F8F8F8" }} >
                <Container>
                    {/* <div style={{ display: "flex", justifyContent: "center", alignItems: "center", alignContent: "center", height: "100vh" }}> */}
                        <Grid container spacing={0}>
                            <Grid xs={12} md={6}>
                                <Stack direction="column" >
                                    ...
                                    <Stack direction="column" spacing={2} pt={2}>
                                        <Typography variant="paragraph" sx={{ width: "90%", fontFamily: "Roboto", lineHeight: "40px" }} fontWeight="normal" fontSize={{ xs: "15px", md: "23px" }} color="#6E6B7B">
                                        ...
                                        <Typography variant="paragraph" sx={{ alignSelf: "start", fontFamily: "Roboto", lineHeight: "23px" }} fontWeight="normal" fontSize={{ xs: "15px", md: "23px" }} color="#6E6B7B">
                                            That's where RequireSign comes in.
                                        </Typography>

                                        <Button sx={{
                                            backgroundColor: "#25B2E8", fontFamily: "Roboto", height: "45px", fontWeight: "bold", borderRadius: "10px", fontSize: "15px", color: "white", textTransform: "capitalize", width: "130px",
                                            "&:hover": {
                                                backgroundColor: "#25B2E8", fontFamily: "Roboto", height: "45px", fontWeight: "bold", borderRadius: "10px", fontSize: "15px", color: "white", textTransform: "capitalize", width: "130px",
                                            }
                                        }}>Try for FREE
                            ...
                            <Grid xs={12} md={6} align="center">
                                <Box component="img" src={aboutus_main} sx={{ width: "100%" }} />
                            </Grid>
                        </Grid>
                    {/* </div> */}
                </Container>
            ...
            <Box pt={3} pb={5}>
                <Container>
                    <Grid container spacing={0}>
                        <Grid xs={12} md={6}>
                            <Box component="img" src={aboutus_sec1} sx={{ alignSelf: "start", width: "100%" }} />
                        </Grid>

                        <Grid xs={12} md={6}  >
                            <Stack pt={10}>
                                <div style={{ display: "flex", justifyContent: "right", alignContent: "right" }}>
                                    <Typography variant="paragraph" sx={{ width: "85%", fontFamily: "Roboto", lineHeight: "35px" }} fontWeight="normal" fontSize={{ xs: "15px", md: "22px" }} color="#6E6B7B">
                        ...
                        <Grid xs={12} md={6}>
                            <Box component="img" src={aboutus_sec2} sx={{ alignSelf: "start", width: "100%" }} />
                        </Grid>
