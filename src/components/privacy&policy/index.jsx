                                ...
                                <Stack direction="column" spacing={2}>
                                    <div>
                                        <Typography
                                            ...
                                            color="#020202"
                                        >
                                            Access and Update: <span style={{ fontWeight: "normal", color: "#6E6B7B" }}>You can access and update your personal information through your account settings. Delete: You can request the deletion of your personal information by contacting us at [Contact Email]. Please note that certain information may be retained for legal or administrative purposes. Opt-Out: You can opt out of receiving promotional communications from us by following the unsubscribe instructions in our emails.</span>
                                        </Typography>
                                    </div>
                                </Stack>
                                ...
                                <Stack direction="column" spacing={2}>
                                    <div>
                                        <Typography
                                            ...
                                            color="#020202"
                                        >
                                            <span style={{ fontWeight: "normal", color: "#6E6B7B" }}>If you have any questions or concerns about this Privacy Policy, please contact us at [Contact Email]</span>
                                        </Typography>
                                    </div>
                                </Stack>
